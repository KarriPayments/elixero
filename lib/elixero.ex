  ...
  def create_client(custon_creds) when is_atom(custon_creds) do
    case(Application.get_env(:elixero, custon_creds, :app_type)) do
      :private_multi -> %EliXero.Client{app_type: :private_multi,
        app_creds: %{
          oauth_consumer_key: Application.get_env(:elixero, custon_creds, :consumer_key),
          oauth_consumer_secret: Application.get_env(:elixero, custon_creds, :consumer_secret),
          application_type: Application.get_env(:elixero, custon_creds, :app_type),
          private_key: Application.get_env(:elixero, custon_creds, :private_key_path)
        },
