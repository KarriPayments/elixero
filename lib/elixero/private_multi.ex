defmodule EliXero.PrivateMulti do
  ...
  def find(client, resource, api_type) do
    ...
    header = EliXero.Utils.OauthMulti.create_auth_header("GET", url, [oauth_token: access_token["oauth_token"]], client)
  ...
  def create(client, resource, api_type, data_map) do
    ...
    header = EliXero.Utils.OauthMulti.create_auth_header(method, url, [oauth_token: access_token["oauth_token"]], client)
  ...
  def delete(client, resource, api_type) do
    ...
    header = EliXero.Utils.OauthMulti.create_auth_header("DELETE", url, [oauth_token: access_token["oauth_token"]], client)
  ...
  def upload_multipart(client, resource, api_type, path_to_file, name) do
    ...
    header = EliXero.Utils.OauthMulti.create_auth_header("POST", url, [oauth_token: access_token["oauth_token"]], client)
  ...
  def upload_attachment(client, resource, api_type, path_to_file, filename, include_online) do
    ...
    header = EliXero.Utils.OauthMulti.create_auth_header("POST", url_for_signing, [oauth_token: access_token["oauth_token"]], client)
